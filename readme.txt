Chg1: This repo was created to establish a collaborative env for all students within C4V.
Chg2: https://github.com/rldevries/C4V_Project.git
<<<<<<< HEAD
Chg3: changed git editor fm vim to notepad
=======
